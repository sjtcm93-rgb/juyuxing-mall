...
const API = {
  ...
  claimAgentInvite: (token, profile, options) => call('agent', { action: 'claimInvite', token, profile: profile || {} }, options),
  updateAgentProfile: (data, options) => call('agent', Object.assign({ action: 'updateProfile' }, data || {}), options),
